				...
				<li class="nav-item active">
					<form name="CreatePatient" method="POST" action="controller">
						...
						<button class="form__btn form__btn_menu" type="submit">
							<fmt:message key="create_patient" />
						</button>
					</form>
				</li>
				<li class="nav-item">
					<form name="ShowPatients" method="POST" action="controller">
						<input type="hidden" name="command" value="show_patients" />
						<button class="form__btn form__btn_menu" type="submit">
							<fmt:message key="show_patients" />
						</button>
					</form>
				</li>
				<li class="nav-item">
					<form name="ShowPurpose" method="POST" action="controller">
						<input type="hidden" name="command" value="show_staff_purpose" />
						<button class="form__btn form__btn_menu" type="submit">
							<fmt:message key="show_purposes" />
						</button>
					</form>
				</li>
			</ul>
